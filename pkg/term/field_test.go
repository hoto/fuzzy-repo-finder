...
func Test_have_zero_query_size(t *testing.T) {
	query := field{}

	assert.Equal(t, 0, query.querySize())
}

func Test_have_empty_query(t *testing.T) {
	query := NewField("", "")

	assert.Equal(t, true, query.queryIsEmpty())
}

func Test_return_query_size(t *testing.T) {
...
func Test_return_title_size(t *testing.T) {
...
func Test_return_whole_field_size(t *testing.T) {
...
func Test_erase_query(t *testing.T) {
	query := NewField("", "QUERY")
...
func Test_leave_query_empty_when_attempting_to_delete_last_char(t *testing.T) {
	query := NewField("", "")
...
func Test_append_char_to_query(t *testing.T) {
	query := NewField("", "QUERY")
	xRune := rune(120)
...
func Test_delete_last_query_char(t *testing.T) {
	query := NewField("", "QUERY")
...
func Test_return_query_runes(t *testing.T) {
	query := NewField("", "QUERY")
...
func Test_return_title_runes(t *testing.T) {
	query := NewField("TITLE", "")
